...
ADD COLUMN IF NOT EXISTS sepa_mandate_status text CHECK (sepa_mandate_status IN ('pending', 'active', 'revoked')),
...
-- Create function to update subscription payment dates
